SAMPLE_FLAGS="--batch_size 5 --num_samples 10 --timestep_respacing ddim25 --use_ddim True --classifier_guidance False --classifier_scale 0.0"
...
mpiexec -n $GPU_COUNT python classifier_sample.py \
    ...
    --results_dir "uncond_ddim25_baseline" \
    --save_png True \
    $SAMPLE_FLAGS \
    $MODEL_FLAGS \
    $UNCOND_FLAGS